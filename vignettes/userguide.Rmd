...
vignette: >
  %\VignetteIndexEntry{1. User guide}
...
The `r Biocpkg("DelayedArraySaver")` package saves `DelayedArray` objects for efficient, portable and stable reproduction of delayed operations in a new R session or other programming frameworks.
...
file.info(fname)[["size"]] # size of the actual file
